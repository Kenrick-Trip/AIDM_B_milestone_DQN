...
do
      cp experiments/mountaincar/configurations/traditional_milestones/MCtraditionalmilestones.yaml "/tmp/config_$1_$2.yaml"
      ...
      python3 experiments/mountaincar/main.py -c "/tmp/config_$1_$2.yaml"
done
