...
class MountainCarMilestonesEnv(gym.Env):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def render(self, mode="human"):
        ...
        flagm1x = int((self.milestone1 - self.min_position) * scale)
        flagm1y1 = int(self._height(self.milestone1) * scale)
        flagm1y2 = flagm1y1 + 30
        gfxdraw.vline(self.surf, flagm1x, flagm1y1, flagm1y2, (0, 0, 0))

        flagm2x = int((self.milestone2 - self.min_position) * scale)
        flagm2y1 = int(self._height(self.milestone2) * scale)
        flagm2y2 = flagm2y1 + 30
        gfxdraw.vline(self.surf, flagm2x, flagm2y1, flagm2y2, (0, 0, 0))
